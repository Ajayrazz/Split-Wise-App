  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-emerald-500/20 blur-[120px] animate-pulse"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-blue-500/20 blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-[40%] left-[20%] w-[30%] h-[30%] rounded-full bg-purple-500/10 blur-[80px] animate-pulse" style={{ animationDelay: '3s' }}></div>
      </div>

      {/* Floating 3D Shapes */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-gradient-to-bl from-emerald-400 to-emerald-600 rounded-full opacity-20 blur-[2px] animate-[bounce_10s_infinite]"></div>
        <div className="absolute bottom-1/4 left-1/4 w-24 h-24 bg-gradient-to-tr from-blue-400 to-emerald-400 rounded-xl opacity-20 rotate-45 blur-[1px] animate-[spin_15s_linear_infinite]"></div>
        <div className="absolute top-1/3 left-1/3 w-16 h-16 bg-gradient-to-br from-purple-400 to-rose-400 rounded-lg opacity-20 rotate-12 blur-[2px] animate-[ping_12s_cubic-bezier(0,0,0.2,1)_infinite]"></div>
      </div>
